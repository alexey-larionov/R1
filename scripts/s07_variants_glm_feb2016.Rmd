...
variants_assoc.mx.chr <- c("Variant", "N_cases", "Effect", "SE", "P_Wald", "P_LRT", "P_Score")
...
rm(variant, 
   cases.included, genotypes.in.model, 
   Effect, SE, P.Wald, P.LRT, P.Score, 
   chi.stat.LRT, Score.Z, results, 
   glm.geno, glm.null)
...
dim(variants_assoc.mx)
variants_assoc.mx[1:7,]
