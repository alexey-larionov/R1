...
# Clean-up
rm(gt, d, d.a, Y, Q, W, G, r, Gene, Gene.List, Variant.List, 
   skat.reg, skat.reg.null, r, keep, M, P.SKAT)
...
write.table(SKAT.results.df, "results/SKAT14_Results.txt", sep="\t", quote=FALSE)
write.table(top.genes.df, "results/SKAT14_TopGenes.txt", sep="\t", quote=FALSE)
...
save.image(file="data/s14_aggregate_by_SKAT.RData")
